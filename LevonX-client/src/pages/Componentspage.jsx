      ...
      Sign in first to browse prebuilt components, live previews, and usage guides.
        ...
        <div className="w-full max-w-md mx-auto text-left space-y-4 mb-8">
          ...
          <div>
            ...
            <CodeBlock code={`npm install levonx-lib`} lang="bash" />
          </div>
          ...
          <div>
            ...
            <CodeBlock code={`import { ComponentName } from "levonx-lib";`} lang="jsx" />
          </div>
...
function DetailPanel({ component, onBack }) {
  ...
  const importCode = `import { ${component.name} } from "levonx-lib";`;
  const usageCode = `import { ${component.name} } from "levonx-lib";\n\nexport default function App() {\n  return (\n    <div>\n      <${component.name}${
